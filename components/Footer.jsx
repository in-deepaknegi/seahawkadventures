        ...
        <footer className="bg-slate-50">
            <div className="mx-auto max-w-full px-4 py-16 sm:px-6 lg:px-8">
                <div className="lg:flex w-full justify-between">
                    ...
                    <div
                        className="mt-8 grid grid-cols-2 mx-10 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <div className="mt-8 border-t border-gray-100 pt-8 ">
                    <div className="sm:flex sm:justify-between">
                        ...
                        <ul
                            className="mt-8 hidden lg:flex flex-wrap justify-start gap-4 text-xs sm:mt-0 lg:justify-end"
                        >
                            <li>
                                <a
                                    href="#"
