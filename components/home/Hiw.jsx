    ...
    return (
        <section className='bg-white px-6 py-24 lg:py-32 lg:px-8'>
            <div className='mx-auto max-w-2xl md:text-center'>
                <p className='text-base font-semibold leading-7 text-orange-500' data-aos="fade-up" data-aos-duration="1000">
                    Get familiar with our process
                </p>
                <h2 className='mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl' data-aos="fade-up" data-aos-duration="1000">
                    Book Your Next Adventure With Us
                </h2>
                <p className='mt-6 text-lg leading-8 text-gray-600' data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className='mx-auto mt-16 hidden max-w-6xl lg:grid grid-cols-1 gap-8 lg:grid-cols-3'>
                {Steps.map((step) => (
                    <div key={step.id} className='flex flex-row md:flex-col'
                        data-aos="fade-right" data-aos-duration="1000" data-aos-delay={step.delay}>
            ...
            <div className="mt-16 flex items-center justify-center gap-x-6">
                ...
                data-aos="fade-right" data-aos-duration="1000" data-aos-offset="300" data-aos-delay="300">
