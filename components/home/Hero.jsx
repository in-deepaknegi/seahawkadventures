        ...
        style={{
            ...
            <div className='mx-auto max-w-5xl text-center px-6 py-52 lg:py-40 lg:px-0'
                ...
                <div className='mt-10 flex items-center justify-center gap-x-6'>
                    <a href='/explore' className='rounded-md bg-orange-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-600' data-aos="fade-up" data-aos-duration="1000" >
                        Discover trips
                    </a>
                    <a href="/#newsletter" className='text-sm font-semibold leading-6 text-orange-500 my-auto' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
