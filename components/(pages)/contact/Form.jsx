            ...
            >
                <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                    <form className="form space-y-5 max-w-xl px-6 mx-auto my-10 lg:my-24">
                        ...
                        <button
                            type="submit"
                            className="py-3 px-5 text-sm font-medium text-center bg-orange-500 text-white rounded-lg sm:w-fit focus:ring-4 focus:outline-none focus:ring-primary-300"
                        >
                            Send message
                        </button>
                    </form>
